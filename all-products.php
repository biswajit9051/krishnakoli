...
<div class="container-fluid">
	...
	<div class="row">
		<div class="page_navigation w-100">
		    <nav aria-label="breadcrumb">
			  	<ol class="breadcrumb border-0 rounded-0">
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h5 class="text-center">OUR COLLECTIONS</h5>
		</div>
	</div>
	<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="card mt-3 mb-1">
					  	...
					  	<div class="card mt-1 mb-1">
						    <div class="card-header bg-white border-0" id="headingOne">
						      	<h6 class="mb-0" data-toggle="collapse" data-target="#PRICE">
						          	PRICE
						          	<i class="fa fa-angle-down float-right" aria-hidden="true"></i>
						     	 </h6>
						    </div>
					  	...
					  	<div class="card mt-1 mb-1">
						    <div class="card-header bg-white border-0" id="headingOne">
						      	<h6 class="mb-0" data-toggle="collapse" data-target="#CUSTOMER-RATINGS">
						          	CUSTOMER RATINGS
						          	<i class="fa fa-angle-down float-right" aria-hidden="true"></i>
						     	 </h6>
						    </div>
					  	...
					  	<div class="card mt-1 mb-1">
						    <div class="card-header bg-white border-0" id="headingOne">
						      	<h6 class="mb-0" data-toggle="collapse" data-target="#DISCOUNT">
						          	DISCOUNT
						          	<i class="fa fa-angle-down float-right" aria-hidden="true"></i>
						     	 </h6>
						    </div>
					  	...
					  	<div class="card mt-1 mb-1">
						    <div class="card-header bg-white border-0" id="headingOne">
						      	<h6 class="mb-0"  data-toggle="collapse" data-target="#AVAILABILITY">
						          	AVAILABILITY
						          	<i class="fa fa-angle-down float-right" aria-hidden="true"></i>
						     	 </h6>
						    </div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="product-info d-flex justify-content-between mb-lg-4 mb-md-3 mb-sm-2 align-items-center">
						<div class="right">Product <span class="text-grey">526</span></div>
						<div class="left">
							<div class="w-100">
