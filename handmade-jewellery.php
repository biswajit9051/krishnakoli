...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h5 class="text-center text-blue mt-4 mb-3">HANDMADE JEWELLERY COLLECTIONS</h5>
			<hr class="kk-hr">
		</div>
	</div>
	<div class="row">
		...
		<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
				...
				<div class="page_navigation w-100">
				    <nav aria-label="breadcrumb" class="bg-none">
					  	<ol class="breadcrumb bg-none border-0 rounded-0">
					    	...
					    	<li class="breadcrumb-item active" aria-current="page">Handmade Jewellery</li>
					  	</ol>
					</nav>
			  	</div>  
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="product-info d-flex justify-content-between mb-lg-4 mb-md-3 mb-sm-2 mb-xs-2 align-items-center">
						<div class="right text-blue">Product <span class="text-grey">526</span></div>
						<div class="left">
							<div class="w-100">
